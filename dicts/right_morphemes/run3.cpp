...
int main()
{
    ...
    for(iterator it = root_v.begin(); it != root_v.end(); ++it) {
        for (iterator it2 = pre_v.begin(); it2 != pre_v.end(); ++it2) {
            for (iterator it3 = end_v.begin(); it3 != end_v.end(); ++it3) {
                to_check = *it2 + *it + *it3; to_write = "=" + *it2 + "," + *it + ",-" + *it3;
            ...
            for (iterator it3 = pre_v.begin(); it3 != pre_v.end(); ++it3) {
                if (*it2 != *it3) {
                    to_check = *it2 + *it3 + *it; to_write = "=" + *it2 + ",=" + *it3 + "," + *it;
                    ...
                    for (iterator it4 = end_v.begin(); it4 != end_v.end(); ++it4) {
                        to_check = *it2 + *it3 + *it + *it4; to_write = "=" + *it2 + ",=" + *it3 + "," + *it + ",-" + *it4;
        ...
        for(iterator it2 = root_v.begin(); it2 != root_v.end(); ++it2) {
            if (*it2 != *it) {
                for(iterator it3 = end_v.begin(); it3 != end_v.end(); ++it3) {
                    to_check = *it + *it3 + *it2; to_write = *it + ",-" + *it3 + "," + *it2;
                    ...
                    if (etalon_h.find(to_check) != etalon_h.end())
                    {
                        ...
                        std::cout << "Multiroot : " << to_write << std::endl;
                    }

                    for(iterator it4 = end_v.begin(); it4 != end_v.end(); ++it4) {
                        to_check = *it + *it3 + *it2 + *it4; to_write = *it + ",-" + *it3 + "," + *it2 + ",-" + *it4;
